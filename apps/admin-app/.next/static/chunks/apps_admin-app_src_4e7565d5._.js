        ...
        "AgentsPage.useCallback[loadAgents]": async function() {
            ...
            try {
                ...
                const timeoutId = setTimeout({
                    "AgentsPage.useCallback[loadAgents].timeoutId": ()=>controller.abort()
                }["AgentsPage.useCallback[loadAgents].timeoutId"], 30000); // Increased to 30s
                ...
                if (!contentType || !contentType.includes('application/json')) {
                    throw new Error("Expected JSON but got ".concat(contentType));
                }
                ...
                if (error.name !== 'AbortError') {
                    ...
                    if (!((_error_message2 = error.message) === null || _error_message2 === void 0 ? void 0 : _error_message2.includes('timeout')) && !((_error_message3 = error.message) === null || _error_message3 === void 0 ? void 0 : _error_message3.includes('connection'))) {
                        setAgents([]);
                    }
                }
            } finally{
...
//# sourceMappingURL=apps_admin-app_src_4e7565d5._.js.map