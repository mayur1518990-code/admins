...
"[project]/apps/admin-app/src/app/agent/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AgentDashboard() {
    ...
    const fetchAssignedFiles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AgentDashboard.useCallback[fetchAssignedFiles]": async function() {
            ...
            try {
                ...
                if (!forceRefresh) {
                    ...
                    if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2d$app$2f$src$2f$lib$2f$cache$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isFresh"])(cached, 180_000)) {
                ...
                if (data.success) {
                    console.log("[DEBUG] API returned ".concat(data.files.length, " files"));
                    console.log("[DEBUG] File statuses:", data.files.map({
                        "AgentDashboard.useCallback[fetchAssignedFiles]": (f)=>({
                                id: f.id,
                                status: f.status,
                                name: f.originalName
                            })
                    }["AgentDashboard.useCallback[fetchAssignedFiles]"]));
                    setFiles(data.files);
    ...
    }["AgentDashboard.useCallback[fetchAssignedFiles]"], []); // Empty deps - stable callback
    ...
    const updateFileStatus = async (fileId, status)=>{
        ...
        try {
            const response = await fetch("/api/agent/files/".concat(fileId, "/status"), {
                method: 'PATCH',
                headers: {
                    'Content-Type': 'application/json'
                },
            ...
            if (data.success) {
                ...
                setFiles((prev)=>{
                    const updatedFiles = prev.map((file)=>file.id === fileId ? {
                            ...file,
                            status
                        } : file);
                ...
                const statusMessage = status === 'processing' ? 'File status updated to Processing! ✅\n\nProcessing count increased. You can now upload the completed file.' : 'File marked as Completed! ✅';
                alert(statusMessage);
                console.log("[DEBUG] File ".concat(fileId, " status changed to: ").concat(status));
            } else {
    ...
    const downloadOriginalFile = async (fileId, filename)=>{
        try {
            console.log("[AGENT-DOWNLOAD] Attempting to download file ".concat(fileId, " with name ").concat(filename));
            const response = await fetch("/api/agent/files/".concat(fileId, "/download"));
            console.log("[AGENT-DOWNLOAD] Response status: ".concat(response.status));
            if (response.ok) {
                const blob = await response.blob();
                console.log("[AGENT-DOWNLOAD] Blob size: ".concat(blob.size, " bytes"));
                ...
                alert("Download failed: ".concat(errorData.error || 'Unknown error'));
            }
        } catch (error) {
    ...
    const uploadCompletedFile = async (fileId)=>{
        ...
        try {
            ...
            const response = await fetch("/api/agent/files/".concat(fileId, "/upload"), {
                method: 'POST',
                body: formData
            });
            const data = await response.json();
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        className: "px-4 py-2 rounded-lg font-medium transition-colors ".concat(statusFilter === 'all' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'),
                                        children: [
                                            "All Files (",
                                            stats.totalAssigned,
                                            ")"
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        className: "px-4 py-2 rounded-lg font-medium transition-colors ".concat(statusFilter === 'assigned' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'),
                                        children: [
                                            "Pending (",
                                            stats.pending,
                                            ")"
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        className: "px-4 py-2 rounded-lg font-medium transition-colors ".concat(statusFilter === 'processing' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'),
                                        children: [
                                            "Processing (",
                                            stats.processing,
                                            ")"
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        className: "px-4 py-2 rounded-lg font-medium transition-colors ".concat(statusFilter === 'completed' ? 'bg-blue-600 text-white' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'),
                                        children: [
                                            "Completed (",
                                            stats.completed,
                                            ")"
                            ...
                            filteredFiles.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        ...
                                        children: statusFilter === 'all' ? 'You have no assigned files yet.' : 'No files with status "'.concat(statusFilter, '" found.')
                                    }, void 0, false, {
                                        fileName: "[project]/apps/admin-app/src/app/agent/page.tsx",
                                        lineNumber: 430,
                                        columnNumber: 15
                                            ...
                                            children: [
                                                        ...
                                                        children: [
                                                                ...
                                                                children: [
                                                                    ...
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                        ...
                                                                        children: [
                                                                            ...
                                                                            file.userEmail && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                                className: "text-sm text-gray-500",
                                                                                children: [
                                                                                    "User: ",
                                                                                    file.userEmail
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                ...
                                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                    className: "inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ".concat(getStatusColor(file.status)),
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        (file.status === 'assigned' || file.status === 'paid') && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                    ...
                                                                    children: updatingStatus === file.id ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                                                                        children: [
                                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("svg", {
                                                        ...
                                                        file.status === 'processing' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                        ...
                                                        file.status === 'completed' && file.completedFile && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            className: "text-sm text-gray-500",
                                                            children: [
                                                                "Completed: ",
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("input", {
                                ...
                                onChange: (e)=>{
                                    var _e_target_files;
                                    return setUploadFile(((_e_target_files = e.target.files) === null || _e_target_files === void 0 ? void 0 : _e_target_files[0]) || null);
                                },
...
_s(AgentDashboard, "FTYdXzXNagPfpzvv0qmqWFoIK/0=", false, function() {
    return [
...
//# sourceMappingURL=_81bdb3de._.js.map