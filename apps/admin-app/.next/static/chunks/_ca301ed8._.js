...
function TransactionsPage() {
    ...
    const [selectedTransactions, setSelectedTransactions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    // Debounce search term to avoid excessive API calls
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TransactionsPage.useEffect": ()=>{
            const timer = setTimeout({
                "TransactionsPage.useEffect.timer": ()=>{
                    setDebouncedSearch(searchTerm);
                }
            }["TransactionsPage.useEffect.timer"], 500); // 500ms debounce
            return ({
                "TransactionsPage.useEffect": ()=>clearTimeout(timer)
            })["TransactionsPage.useEffect"];
        }
    }["TransactionsPage.useEffect"], [
        searchTerm
    ...
    const toggleTransactionSelection = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "TransactionsPage.useCallback[toggleTransactionSelection]": (id)=>{
            setSelectedTransactions({
                "TransactionsPage.useCallback[toggleTransactionSelection]": (prev)=>prev.includes(id) ? prev.filter({
                        "TransactionsPage.useCallback[toggleTransactionSelection]": (x)=>x !== id
                    }["TransactionsPage.useCallback[toggleTransactionSelection]"]) : [
                        ...prev,
                        id
                    ]
            }["TransactionsPage.useCallback[toggleTransactionSelection]"]);
    ...
    const allSelected = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TransactionsPage.useMemo[allSelected]": ()=>selectedTransactions.length > 0 && transactions.every({
                "TransactionsPage.useMemo[allSelected]": (t)=>selectedTransactions.includes(t.id)
            }["TransactionsPage.useMemo[allSelected]"])
    }["TransactionsPage.useMemo[allSelected]"], [
    ...
    const toggleSelectAll = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "TransactionsPage.useCallback[toggleSelectAll]": ()=>{
            if (allSelected) setSelectedTransactions([]);
            else setSelectedTransactions(transactions.map({
                "TransactionsPage.useCallback[toggleSelectAll]": (t)=>t.id
            }["TransactionsPage.useCallback[toggleSelectAll]"]));
        }
    }["TransactionsPage.useCallback[toggleSelectAll]"], [
        allSelected,
    ...
    const handleDeleteSelected = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "TransactionsPage.useCallback[handleDeleteSelected]": async ()=>{
            if (selectedTransactions.length === 0) return;
            const confirmed = window.confirm("Delete ".concat(selectedTransactions.length, " selected transaction(s)? This cannot be undone."));
            if (!confirmed) return;
            try {
                const prev = transactions;
                setTransactions(prev.filter({
                    "TransactionsPage.useCallback[handleDeleteSelected]": (t)=>!selectedTransactions.includes(t.id)
                }["TransactionsPage.useCallback[handleDeleteSelected]"]));
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        ...
                        transactions.length === 0 && !isLoading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(TransactionsPage, "pGq3rvOx6hjoT4BBN6F+LyE6w6Y=");
...
//# sourceMappingURL=_ca301ed8._.js.map