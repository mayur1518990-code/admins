...
const DashboardStats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(()=>__turbopack_context__.A("[project]/apps/admin-app/src/components/DashboardStats.tsx [app-ssr] (ecmascript, next/dynamic entry, async loader)").then((m)=>m.DashboardStats), {
    loadableGenerated: {
        modules: [
            "[project]/apps/admin-app/src/components/DashboardStats.tsx [app-client] (ecmascript, next/dynamic entry)"
        ]
    }
});
const RecentActivity = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(()=>__turbopack_context__.A("[project]/apps/admin-app/src/components/RecentActivity.tsx [app-ssr] (ecmascript, next/dynamic entry, async loader)").then((m)=>m.RecentActivity), {
    loadableGenerated: {
        modules: [
            "[project]/apps/admin-app/src/components/RecentActivity.tsx [app-client] (ecmascript, next/dynamic entry)"
        ]
    }
});
const QuickActions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$shared$2f$lib$2f$app$2d$dynamic$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"])(()=>__turbopack_context__.A("[project]/apps/admin-app/src/components/QuickActions.tsx [app-ssr] (ecmascript, next/dynamic entry, async loader)").then((m)=>m.QuickActions), {
    loadableGenerated: {
        modules: [
            "[project]/apps/admin-app/src/components/QuickActions.tsx [app-client] (ecmascript, next/dynamic entry)"
        ]
    }
});
;
...
function AdminDashboard() {
    ...
    const loadDashboardData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (forceRefresh = false)=>{
        ...
        try {
            ...
            if (result.success) {
                ...
                setError("");
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2d$app$2f$src$2f$lib$2f$cache$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["setCached"])(cacheKey, result); // Cache for next time
            } else {
...
//# sourceMappingURL=_52249058._.js.map