module.exports = [
"[project]/apps/admin-app/.next-internal/server/app/api/admin/transactions/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/apps/admin-app/src/app/api/admin/transactions/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        const cacheKey = (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2d$app$2f$src$2f$lib$2f$server$2d$cache$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["makeKey"])('transactions', [
            status || 'all',
            userId || 'all',
            fileId || 'all',
            startDate || 'all',
        ...
        let query = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2d$app$2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminDb"].collection('payments');
        if (status) {
        ...
        const [usersMap, filesMap] = await Promise.all([
            ...
            (async ()=>{
                ...
                const userPromises = userIdArray.map((id)=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2d$app$2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminDb"].collection('users').doc(id).get());
            ...
            (async ()=>{
                ...
                const filePromises = fileIdArray.map((id)=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2d$app$2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminDb"].collection('files').doc(id).get());
        ...
        if (search) {
            ...
            transactions = transactions.filter((t)=>{
                return t.user?.name?.toLowerCase().includes(searchLower) || t.user?.email?.toLowerCase().includes(searchLower) || t.file?.originalName?.toLowerCase().includes(searchLower) || t.razorpayPaymentId?.toLowerCase().includes(searchLower) || t.razorpayOrderId?.toLowerCase().includes(searchLower);
            });
        }
        ...
        for (const t of transactions){
            ...
            if (newHasLinks > currentHasLinks || newHasLinks === currentHasLinks && newRank > currentRank || newHasLinks === currentHasLinks && newRank === currentRank && newTime > currentTime) {
                dedupedMap.set(key, t);
            }
        }
        ...
        if (!fresh) {
            __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2d$app$2f$src$2f$lib$2f$server$2d$cache$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["serverCache"].set(cacheKey, payload, 10_000); // 10s cache for fresher data
        }
...
async function POST(request) {
    try {
        ...
        const transactionDoc = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2d$app$2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminDb"].collection('payments').doc(transactionId).get();
        ...
        // Update transaction
        const transactionRef = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2d$app$2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminDb"].collection('payments').doc(transactionId);
        batch.update(transactionRef, updateData);
        // If refunding, update file status
        if (status === 'refunded') {
            const fileRef = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2d$app$2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminDb"].collection('files').doc(transactionData.fileId);
        ...
        if (status === 'captured') {
            try {
                const sameFilePending = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2d$app$2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminDb"].collection('payments').where('fileId', '==', transactionData.fileId).where('status', '==', 'pending').get();
                const sameOrderPending = transactionData.razorpayOrderId ? await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2d$app$2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminDb"].collection('payments').where('razorpayOrderId', '==', transactionData.razorpayOrderId).where('status', '==', 'pending').get() : {
                    empty: true,
                    docs: []
                };
                const toDelete = new Set();
                sameFilePending.docs.forEach((doc)=>{
                    if (doc.id !== transactionId) toDelete.add(doc.id);
                });
                sameOrderPending.docs.forEach((doc)=>{
                    if (doc.id !== transactionId) toDelete.add(doc.id);
                });
                if (toDelete.size > 0) {
                    const ids = Array.from(toDelete);
                    for(let i = 0; i < ids.length; i += 500){
                        const batchDel = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2d$app$2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminDb"].batch();
                        ids.slice(i, i + 500).forEach((id)=>batchDel.delete(__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2d$app$2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminDb"].collection('payments').doc(id)));
...
async function DELETE(request) {
    try {
        ...
        const idsToDelete = Array.isArray(transactionIds) ? transactionIds.filter(Boolean) : transactionId ? [
            transactionId
        ] : [];
        if (!idsToDelete.length) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: 'Transaction ID(s) are required'
            }, {
                status: 400
            });
        }
        ...
        for (const chunk of chunks){
            const batch = __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2d$app$2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminDb"].batch();
            const docs = await Promise.all(chunk.map((id)=>__TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2d$app$2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminDb"].collection('payments').doc(id).get()));
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2d$app$2f$src$2f$lib$2f$server$2d$cache$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["serverCache"].deleteByPrefix('admin:transactions');
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1ac26770._.js.map