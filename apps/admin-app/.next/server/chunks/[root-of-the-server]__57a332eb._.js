module.exports = [
"[project]/apps/admin-app/.next-internal/server/app/api/agent/login/route/actions.js [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__, module, exports) => {
...
"[project]/apps/admin-app/src/app/api/agent/login/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const agentsSnapshot = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2d$app$2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminDb"].collection('agents').where('email', '==', email).limit(1).get();
        ...
        let firebaseUser;
        try {
            firebaseUser = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2d$app$2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminAuth"].getUser(agentId);
        } catch (error) {
        ...
        const customToken = await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2d$app$2f$src$2f$lib$2f$firebase$2d$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["adminAuth"].createCustomToken(agentId, {
            role: 'agent',
            agentId: agentId,
            name: agentData.name,
            email: agentData.email
...
//# sourceMappingURL=%5Broot-of-the-server%5D__57a332eb._.js.map