...
function AgentDashboard() {
    ...
    const fetchAssignedFiles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCallback"])(async (forceRefresh = false)=>{
        ...
        try {
            ...
            if (!forceRefresh) {
                ...
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$admin$2d$app$2f$src$2f$lib$2f$cache$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["isFresh"])(cached, 180_000)) {
            ...
            if (data.success) {
                ...
                console.log(`[DEBUG] File statuses:`, data.files.map((f)=>({
                        id: f.id,
                        status: f.status,
                        name: f.originalName
                    })));
...
//# sourceMappingURL=_ec413806._.js.map